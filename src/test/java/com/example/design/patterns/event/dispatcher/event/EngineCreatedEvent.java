...
import static com.example.design.patterns.operational.event.dispatcher.type.RuntimeEventType.ENGINE_CREATED;

/**
 * Created by chakib.daii on 7/2/2021.
 */
public class EngineCreatedEvent implements RuntimeEvent{
    ...
    public String toString() {
        return new StringJoiner(", ", EngineCreatedEvent.class.getSimpleName() + "[", "]")
                .add(getExecutionId())
                .add(getType().name())
                .toString();
    }
